  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-b2buy-muted">내 신청 / 참여 현황 · 에스크로 계좌 관리</p>
      </header>

      <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {[
          { label: "참여중인 공구", value: "2건" },
          { label: "예치중인 금액", value: "₩ 4,320,000" },
          { label: "누적 절감액", value: "₩ 1,820,000" }
        ].map((s) => (
      ...
      <section className="rounded-2xl border border-b2buy-line bg-white p-5">
        ...
        <table className="mt-3 w-full text-sm">
          ...
          <tbody>
            {[
              { title: "50ml 유리에센스 병", qty: 1500, price: 250, status: "예치완료" },
